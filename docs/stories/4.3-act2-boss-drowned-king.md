...
- [ ] Design The Drowned King boss (AC: 1, 2, 3)
  - [ ] **The Drowned King** (180 HP) - A monarch who sacrificed himself
    - **Passive: Rising Tide** - Flood level increases each turn (0-10)
      - Flood 3+: All player attacks deal -2 damage
      - Flood 6+: Player takes 3 damage at turn start
      - Flood 10: Tidal Wave auto-triggers
    - **Phase 1: The Protector** (HP > 120)
      - Royal Guard (Block 15, 35%)
      - Trident Thrust (Attack 10, 30%)
      - Call the Depths (Increase Flood by 2, 35%)
    - **Phase 2: The Bargainer** (HP 60-120)
      - Crushing Pressure (Attack 8, Apply Sundered 2, 30%)
      - Desperate Plea (Heal 15, dialogue: "I did this for them...", 25%)
      - Drown (Attack 12, Apply Bound - Skills 1 turn, 25%)
      - Raise Tide (Increase Flood by 3, 20%)
    - **Phase 3: The Lost** (HP < 60)
      - Tidal Wave (Attack 20, reset Flood to 0, 30%)
      - Memory of the Kingdom (Summon 2 Drowned Soldiers, 25%)
      - Final Sacrifice (Attack 25, Lose 20 HP, 25%)
      - Forgotten Purpose (Skip turn, reduce Flood by 5, heal 10, 20%)

- [ ] Design Drowned Soldier minion
  - [ ] **Drowned Soldier** (25 HP) - Memories of his guard
    - Corroded Blade (Attack 6, 60%)
    - Shield Wall (All enemies gain 5 block, 40%)

- [ ] Implement Flood mechanic (AC: 3)
  - [ ] Flood counter (0-10) visible on screen
  - [ ] Flood increases at turn end by boss moves
  - [ ] Flood effects trigger at thresholds
  - [ ] Tidal Wave resets Flood to 0
  - [ ] Visual: water rising effect on battlefield

- [ ] Implement boss dialogue system (AC: 4)
  - [ ] Dialogue triggers on phase transitions
  - [ ] Dialogue triggers on specific moves
  - [ ] Phase 1: "The kingdom... must... survive..."
  - [ ] Phase 2: "I gave everything! Do you understand?"
  - [ ] Phase 3: "I can't... remember their faces anymore..."
  - [ ] Death: "Finally... rest..."

- [ ] Update CombatEngine for boss mechanics
  - [ ] Track Flood level
  - [ ] Apply Flood effects at appropriate times
  - [ ] Handle 3-phase boss logic
  - [ ] Handle boss-specific heal moves
  - [ ] Handle summon soldiers

- [ ] Create boss encounter UI
  - [ ] Large boss health bar with phase markers
  - [ ] Flood meter (water level visual)
  - [ ] Dialogue box for boss speech
  - [ ] Phase transition animation
  - [ ] Drowned aesthetic (bubbles, water effects)

- [ ] Implement boss rewards
  - [ ] Choice of 3 rare cards
  - [ ] 150-200 gold
  - [ ] Boss-specific relic chance: "Crown of the Drowned" (50%)
  - [ ] Full heal between acts

- [ ] Create transition to Act 3
  - [ ] Victory screen with lore text
  - [ ] Warden dialogue: "The Drowned King was my friend once. End his suffering."
  - [ ] Map transition to Sanctum Core

- [ ] Write unit tests
  - [ ] Test Flood increases correctly
  - [ ] Test Flood threshold effects trigger
  - [ ] Test Tidal Wave resets Flood
  - [ ] Test phase transitions at HP thresholds
  - [ ] Test soldier summoning
  - [ ] Test boss dialogue triggers
