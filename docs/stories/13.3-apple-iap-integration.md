...
- [x] Create PurchaseService (AC: 2, 5, 7)
  - [x] Initialize store connection (scaffold)
  - [ ] Fetch product info (prices, descriptions) - requires App Store Connect
  - [x] Handle purchase flow (scaffold)
  - [x] Handle errors gracefully
  - [x] Unlock class on successful purchase (local storage)
