...
- [ ] Design Greater Demon elite (AC: 1, 2, 3)
  - [ ] **Greater Demon** (130 HP) - Lord of a demonic legion
    - **Passive: Infernal Presence** - All damage dealt by player reduced by 2
    ...
    - **Phase 2: Unleashed** (HP <= 65)
      - Infernal presence increases to -4 player damage
...
- [ ] Design Sanctum Warden elite (AC: 1, 2, 3)
  - [ ] **Sanctum Warden** (150 HP) - The dying Warden's last defender
    - **Passive: Reality Anchor** - Player can only draw 4 cards per turn
    - **Normal Moves**:
...
- [ ] Implement elite-specific mechanics
  - [ ] Infernal Presence (global damage reduction)
  - [ ] Reality Anchor (draw reduction)
  - [ ] Time Fracture (hand shuffle)
  - [ ] Memory Projection (periodic summoning)
  - [ ] Track "turns since last summon" for Warden

- [ ] Update CombatEngine for elite mechanics
  - [ ] Apply passive damage reduction
  - [ ] Override draw count
  - [ ] Handle hand shuffle to deck
  - [ ] Handle periodic events (every X turns)
  - [ ] Track one-time abilities per enemy
...
- [ ] Write unit tests
  - [ ] Test Infernal Presence reduces damage
  - [ ] Test Reality Anchor limits draw
  - [ ] Test Memory Projection triggers every 3 turns
  - [ ] Test Time Fracture shuffles hand
  - [ ] Test Warden's Duty only triggers once
  - [ ] Test Memory minions have correct stats
