...
- [ ] Design 6 Act 3 common enemies (AC: 1, 4, 5)
  ...
  - [ ] **Sanctum Guardian** (70 HP) - Ancient protector gone wrong
  ...
  - [ ] **Soul Fragment** (35 HP) - Pieces of consumed delvers
  ...
  - [ ] **Infernal Hound** (50 HP) - Hell beast
    - Bite (Attack 11, 45%)
    - Pounce (Attack 8, Apply Sundered 2, 30%)
    - Howl (All demons gain 2 Might, 25%)

- [ ] Implement enemy definitions (AC: 2, 3)
  - [ ] Create `src/data/enemies/act3.ts`
  - [ ] Add all 6 enemies with proper move definitions
  - [ ] Define moves with proper intent types
  - [ ] Set appropriate weights for move selection

- [ ] Implement new Act 3 mechanics (AC: 6)
  - [ ] **Corruption Stacks**: At 10 stacks, player takes 20 damage and stacks reset
  - [ ] **Intangible**: All incoming damage reduced by 50%
  - [ ] **Card Theft**: Remove card from hand, enemy "plays" it
  - [ ] **HP-scaling attacks**: Damage based on player/enemy HP
  - [ ] **Buff removal**: Strip player buffs
  - [ ] **One-time heal**: Fade mechanic triggers once per enemy

- [ ] Update CombatEngine for new mechanics
  - [ ] Track Corruption Stacks on player
  - [ ] Handle Intangible damage reduction
  - [ ] Handle card theft and enemy playing cards
  - [ ] Handle buff stripping
  - [ ] Handle "once per combat" effects per enemy
  - [ ] Handle pack bonuses (Imp's Giggle, Hound's Howl)

- [ ] Update UI for new mechanics (AC: 3)
  - [ ] Corruption Stack counter (ominous purple)
  - [ ] Intangible visual (ghostly/phased)
  - [ ] Card theft animation
  - [ ] Buff strip animation
  - [ ] Demon synergy indicator

- [ ] Create encounter configurations
  - [ ] Define which enemies can appear together
  - [ ] Max 2 enemies per Act 3 encounter
  - [ ] Balance HP totals per encounter (target: 80-130 HP total)
  - [ ] Thematic pairings (Imp + Hound, Angel + Guardian)

- [ ] Write unit tests
  - [ ] Test each enemy has correct HP and moves
  - [ ] Test Corruption Stacks trigger at 10
  - [ ] Test Intangible reduces damage by 50%
  - [ ] Test card theft removes and plays card
  - [ ] Test Purge removes player buffs
  - [ ] Test Fade only triggers once
