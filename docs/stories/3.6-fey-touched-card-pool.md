...
- [ ] Design Common Fey-Touched cards (15 cards)
  - [ ] **Wild Strike** (1 Resolve): Deal 5-9 damage
  - [ ] **Shifting Shield** (1 Resolve): Gain 5-9 block
  - [ ] **Lucky Coin** (0 Resolve): Gain 2 Luck
  - [ ] **Fey Fire** (1 Resolve): Deal 6 damage. Whimsy: +4 damage OR heal 4 OR draw 1
  - [ ] **Mischief** (1 Resolve): Whimsy: Enemy loses 5 block OR takes 5 damage OR is Impaired 1 turn
  - [ ] **Borrowed Time** (1 Resolve): Draw 2 cards. Discard 1-2 cards randomly at end of turn
  - [ ] **Chaotic Bolt** (1 Resolve): Deal 4 damage to a random enemy 2 times
  - [ ] **Nature's Whim** (1 Resolve): Gain 4 block and 4 HP. Randomly lose one of them next turn
  - [ ] **Gambler's Strike** (1 Resolve): Deal 3 damage. 50% chance to deal 3 more
  - [ ] **Illusory Armor** (1 Resolve): Gain 10 block. 25% chance block is halved
  - [ ] **Fey Blessing** (1 Resolve): Heal 3-7 HP
  - [ ] **Changeling** (1 Resolve): Transform into a random Common card until played
  - [ ] **Lucky Strike** (1 Resolve): Deal 5 damage. Gain 1 Luck
  - [ ] **Trickster's Blade** (1 Resolve): Deal 7 damage. Randomly swap with a card from draw pile
  - [ ] **Fortuitous Block** (1 Resolve): Gain 6 block. If Luck > 5, gain 6 more

- [ ] Design Uncommon Fey-Touched cards (8 cards)
  - [ ] **Wild Magic** (2 Resolve): Whimsy: Deal 15 damage OR Gain 15 block OR Draw 4 cards OR Heal 15 HP
  - [ ] **Luck Surge** (1 Resolve): Gain 5 Luck. Next Whimsy is guaranteed best outcome
  - [ ] **Chaos Theory** (2 Resolve, Power): At turn start, randomly gain: 2 damage, 2 block, or draw 1
  - [ ] **Probability Storm** (2 Resolve): Deal 4 damage 3-5 times randomly
  - [ ] **Fey Bargain** (1 Resolve): Choose: Gain 12 block OR Deal 12 damage (opponent chooses which you get)
  - [ ] **Fortune's Favor** (1 Resolve): Spend all Luck. Gain 2 block and deal 2 damage per Luck spent
  - [ ] **Reality Warp** (2 Resolve): Transform all cards in hand into random cards of same rarity
  - [ ] **Serendipity** (2 Resolve, Power): Whenever you play a Whimsy card, gain 1 Luck

- [ ] Design Rare Fey-Touched cards (3 cards)
  - [ ] **Master of Chaos** (3 Resolve, Power): All Whimsy cards trigger twice
  - [ ] **Wish** (4 Resolve, Exhaust): Choose any outcome from any Whimsy card in your deck
  - [ ] **Fey Lord's Gambit** (2 Resolve): Deal 10-30 damage. Take 0-10 damage. Completely random

- [ ] Implement additional Whimsy effects
  - [ ] Multi-outcome Whimsy (3+ options)
  - [ ] Negative possibility Whimsy (risk/reward)
  - [ ] Scaling Whimsy (based on stats)
  - [ ] Conditional Whimsy (different if Luck high)

- [ ] Implement Luck-based mechanics
  - [ ] Luck generation cards
  - [ ] Luck spending for rerolls
  - [ ] Luck thresholds for bonuses
  - [ ] Luck-based scaling effects
  - [ ] "Guaranteed best" outcome mechanic

- [ ] Implement transformation system
  - [ ] Transform card in hand
  - [ ] Transform card in deck
  - [ ] Temporary transformation (until played)
  - [ ] Transform by rarity (same tier)
  - [ ] Transform all cards effects

- [ ] Implement chaos damage (random targets)
  - [ ] Damage random enemy
  - [ ] Damage random target (including self!)
  - [ ] Multi-hit random targets

- [ ] Write unit tests
  - [ ] Test Whimsy outcome selection
  - [ ] Test damage/block ranges
  - [ ] Test Luck accumulation and spending
  - [ ] Test transformation mechanics
  - [ ] Test random target selection
  - [ ] Test "guaranteed best" with Luck Surge
