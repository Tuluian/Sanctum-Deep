...
- [ ] iCloud save sync (AC: 3)
  - [ ] Install `@capacitor/preferences` or CloudKit plugin
  - [ ] Migrate LocalStorage to iCloud-backed storage
  - [ ] Handle conflict resolution (latest wins)
  - [ ] Test cross-device sync
  - [ ] Fallback to local if iCloud unavailable

- [ ] Share victories (AC: 4)
  - [ ] Install `@capacitor/share`
  - [ ] Create shareable victory card image
  - [ ] Include run stats (class, turns, cards played)
  - [ ] Share to Messages, Twitter, etc.
